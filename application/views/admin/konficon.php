    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          ...
          ?>
          <h3 class="box-title">Ganti Icon</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <?php echo form_open_multipart('admin/konfigurasi/icon'); ?>
            <div class="col-md-5">
              <div class="form-group form-control-lg">
                <label><h3>Upload Icon Baru</h3></label>
                <input type="file" name="icon" required>
              </div>
            </div>
            <div class="col-md-7">
              <div class="form-group">
                <label><h3>Icon Saat ini</h3> <hr></label>
                <p><img src="<?php echo base_url('assets/img/'.$konfigurasi->icon_web); ?>"></p>
              </div>
            </div>
            <div class="col-md-12">
